...
/**
 * @covers \DeepCopy\DeepCopyWeakMap
 */
class DeepCopyWeakMapTest extends TestCase
{
    /**
    ...
    public function test_it_can_copy_an_object()
    {
        ...
        $copy = deep_copy_weak_map($object);
    ...
    public function test_it_only_uses_the_userland_defined_cloned_method_when_configured_to_do_so()
    {
        ...
        $copy = deep_copy_weak_map($object, true);
    ...
    public function test_it_keeps_enums()
    {
        ...
        $copy = (new DeepCopyWeakMap())->copy($enum);
